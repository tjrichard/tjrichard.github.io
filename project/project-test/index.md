...
<button style="padding: 6px 24px; background-color: #2c85ff; border-color: rgba(0, 0, 0, 0.12); border-radius: 4px; color: #ffffff; margin: 4px 0 4px 0; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1); cursor: pointer;" onclick=" window.open('https://coupa.ng/bLNlmS','_blank')">물 500ml 최저가 구매하기 👉</button>
</div>
...
<button style="padding: 6px 24px; background-color: #2c85ff; border-color: rgba(0, 0, 0, 0.12); border-radius: 4px; color: #ffffff; margin: 4px 0 4px 0; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1); cursor: pointer;" onclick=" window.open('https://coupa.ng/bLNkVp','_blank')">탄산수 500ml 최저가 구매하기 👉</button>
</div>
</div>
